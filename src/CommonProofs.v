...
Locate hmapFindWithDefault.

Transparent deduct_currencies_helper 
            TypeAbstraction.Common.hmapFindWithDefault 
            hmapLookup.
...
Proof.
  ...
  induction l; intros.
  - simpl. remember (hmapFindWithDefault (Build_XUBInteger 0) a c).
    destruct x. simpl. f_equal. unfold N.zero. lia.
  - simpl. destruct a0. enough (a = x \/ a <> x).
    destruct H0.
  +
...
Proof using.
  ...
  unfold unwrap in H.
  setoid_rewrite Heq in H. clear Heq H0.
