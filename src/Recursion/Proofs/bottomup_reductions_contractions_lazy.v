...
Ltac solver := bottomup_reductions_contractions_lazy.

Lemma hash_1_prf (ll : LedgerLRecord rec) : hash_1_correct_def ll.
start_proof; hash_1_start.
continue_all_custom .
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][1]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][2]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][3]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][4]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][5]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][6]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][7]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][8]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][9]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_lazy][10]" timeout 300 solver.
Time Qed.