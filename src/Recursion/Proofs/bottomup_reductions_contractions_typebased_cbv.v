...
Ltac solver := bottomup_reductions_contractions_typebased_cbv.

Lemma hash_1_prf (ll : LedgerLRecord rec) : hash_1_correct_def ll.
start_proof; hash_1_start.
continue_all_custom .
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][1]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][2]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][3]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][4]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][5]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][6]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][7]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][8]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][9]" timeout 300 solver.
Time Qed.
...
prepare ll P loc_.
time "[recursion][bottomup_reductions_contractions_typebased_cbv][10]" timeout 300 solver.
Time Qed.